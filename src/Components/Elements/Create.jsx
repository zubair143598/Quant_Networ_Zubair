    ...
    <div className="container  create">
      <div className="row">
        ...
        <div className=" text-center col-md-8">
          <h1>Create value, reduce costs, mitigate risk</h1>
        </div>
        <div className="col-md-2"></div>
      </div>
      ...
      <div className="row">
        ...
        <div className="col-md-2">
          ...
          <p>
            ...
            are being tokenised. Issuers are gaining access to entire new pools
            of liquidity, while investors are diversifying their portfolios in
        ...
        <div className="col">
          <h3>Compliance</h3>
          <p>
            Blockchain can make the analysis of transaction patterns easier for
            tax authorities, regulatory bodies and other responsible
      ...
      <div className="row">
        <div className="col-md-2">
          ...
          <p>
            ...
            crowdfunding, then automatically push the funds to an exchange to be
      ...
      <div className="row">
        ...
        <div className="col-md-2">
          ...
          <p>
            ...
            digital currencies, while commercial entities are issuing their own
            stablecoins – often to great acclaim.
          </p>
        </div>
        <div className="col-md-6"></div>
        <div className="col">
